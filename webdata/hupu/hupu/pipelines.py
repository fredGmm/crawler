...
class HupuPipeline(object):
    ...
    def process_item(self, item, spider):
        ...
        if isinstance(item, HupuItem):
            ...
            select_sql = ("select 1 from hupu_article_list_test1 where article_id = %s")
            ...
            comment_insert_param = [item['article_id'], item['comment_id'], item['comment_uid'], item['comment_content'], item['comment_username'],
